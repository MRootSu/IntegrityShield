...
#
#══════════════════════════════════════════════════════════════════════════
# Mahmoud Rooting King Of The Root 💫 Online Root 🔥
# Telegram : @MRootSu
# WhatsApp : +201015726931
#############################################################################################
...
print_banner() {
    local banner_text='Boot img Flasher By @MRootSu'
    
    local author='Author: @MRootSu'
